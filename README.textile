...
p. First edit __sync.bat__ and set your Lotus Notes installation directory.

p. Now just run the application. It will create a folder __.ngcalsync__ in your home directory, create all necessary files with default values, prompt a message and exit. Now you can edit the created file __sync.properties__ according to your needs.
